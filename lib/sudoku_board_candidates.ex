defmodule SudokuBoardCandidates do
  @moduledoc """
  ...
  @type t :: %SudokuBoardCandidates{
          size: integer,
          grid: %{SudokuBoardCandidates.position() => SudokuBoardCandidates.candidates()}
        }

  @spec equals?(SudokuBoardCandidates.t(), SudokuBoardCandidates.t()) :: boolean
  ...
  """
  @spec new(list(non_neg_integer())) :: SudokuBoardCandidates.t()
  def new(grid) do
    size =
      grid
      |> Enum.count()
    ...
    %SudokuBoardCandidates{grid: transformed_grid, size: size}
  end
  ...
  """
  @spec parse(String.t()) :: {:ok, SudokuBoardCandidates.t()} | {:error, String.t()}
  def parse(str) do
    try do
      grid =
        str
      ...
      board = SudokuBoardCandidates.new(grid)
  ...
  #
  @spec eliminate_candidates(SudokuBoardCandidates.t()) :: SudokuBoardCandidates.t()
  ...
  defp get_affected_cells(%SudokuBoardCandidates{} = board, cell) do
  ...
  def partial_solution?(%SudokuBoardCandidates{} = board) do
    board.grid
  ...
  """
  @spec read_file(String.t()) :: {:ok, SudokuBoardCandidates.t()} | {:error, String.t()}
  ...
  def place_number(%SudokuBoardCandidates{size: size, grid: grid} = board, position, candidate)
  ...
  """
  @spec solved?(SudokuBoardCandidates.t()) :: boolean
  def solved?(%SudokuBoardCandidates{} = board) do
  ...
  ## Parameters
    ...
    - board: A SudokuBoard.t representing a board
  """
  @spec valid?(SudokuBoardCandidates.t()) :: boolean
  def valid?(%SudokuBoardCandidates{size: size, grid: grid}) do
  ...
  defp filled?(%SudokuBoardCandidates{grid: grid}) do
...
defimpl String.Chars, for: SudokuBoardCandidates do
  ...
  @spec to_string(SudokuBoardCandidates.t()) :: String.t()
  def to_string(%SudokuBoardCandidates{size: size, grid: grid}) do
    chunk_size =
      size
      |> :math.sqrt()
      |> trunc
